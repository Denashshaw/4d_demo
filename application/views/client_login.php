...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <form method="post" action="<?php echo base_url();?>login/client_login">
      <?php $client=explode(',',$userdata['client']); ?>
        <p class="clitxt">Select Client</p>

        <select id="cli_dd" class="form-control fadeIn fourth"  style="" name="client" required="">
          <option value="">--Select Client--</option>
          <?php for($i=0;$i<count($client);$i++){ ?>
            <option value="<?php echo $client[$i];?>"><?php echo $client[$i];?></option>
          <?php } ?>
        </select><br>
    ...
    ?>
      <form  action="<?php echo base_url();?>Dataprocess">
        <input type="submit" class="" value="Data Productivity Software">
      </form>
    <?php
  }
  ?>
