...
<?php include('header.php');?>
  ...
  <div class="row emp-table">
    <div class="col-md-7"><br>
              ...
              <p class="activity" style="color:#2a316a;">Submitted Claim Details</p><br>
        ...
        <div class="col-md-5"><br>
          ...
          <input type="hidden" name="unique_id" id="unique_id" value="<?php echo $unid; ?>">
            <div class="row claim_details">
              ...
              <div class="col-md-4">
                <input type="radio" name="error" id="err_yes" required value="Yes">
                <label for="err_yes">Yes</label>
                <input type="radio" name="error" id="err_no" required value="No">
