							...
							<table class="table" id="mytable">
								<thead>
									<tr>
										...
										<th scope="col" class="heading" id="sl" style="cursor:pointer;color:red !important;font-style:italic;">Patient</th>
								...
								<td><span class="emp-break-in"><button class="rework_claim" type="button"  data-toggle="modal" data-target="#reworkModel<?php echo $sj_data->qaId;?>">Rework QA</button></a></span>	
								</td>
