      ...
      <div class="row">
        <div class="col-12 col-md-12 content" style="min-height:780px;">
          ...
          <div class="col-md-5"><br>
            ...
            <p class="claim_data">Created Date : <?php echo $start_call[0]->created_date;?> </p>
            <p class="claim_data">System            : <?php echo $start_call[0]->system;?> </p>
            <p class="claim_data">Claim Id         : <?php echo $start_call[0]->claim_id;?> </p>
            <p class="claim_data">INS                 : <?php echo $start_call[0]->ins;?> </p>
            <p class="claim_data">Patient          : <?php echo $start_call[0]->patient;?> </p>
            <p class="claim_data">Charge                : <?php echo $start_call[0]->charge;?> </p>
            <p class="claim_data">DOS FROM               : <?php echo $start_call[0]->dos_from;?> </p>
            <p class="claim_data">DOS To             : <?php echo $start_call[0]->dos_to;?> </p>
            <p class="claim_data">Sent               : <?php echo $start_call[0]->sent;?> </p>
            <p class="claim_data">FU Date               : <?php echo $start_call[0]->fu_date;?> </p>
            <p class="claim_data">Level Of Care             : <?php echo $start_call[0]->level_of_care;?> </p>
            <p class="claim_data">Status      : <?php echo $start_call[0]->status;?></p>

            <p class="claim_data">Facility      : <?php echo $start_call[0]->facility;?> </p>
            <p class="claim_data">Worked Date               : <?php echo $start_call[0]->worked_date;?> </p>
            <p class="claim_data">Worked Rep    : <?php echo $start_call[0]->worked_rep;?> </p>
            <p class="claim_data">Notes    : <?php echo $start_call[0]->notes;?> </p>
            <p class="claim_data">Completed    : <?php echo $start_call[0]->completed;?> </p>
            <p class="claim_data">Claim    : <?php echo $start_call[0]->claim;?> </p>
            <p class="claim_data">Allowed    : <?php echo $start_call[0]->allowed;?> </p>
            <p class="claim_data">Paid    : <?php echo $start_call[0]->paid;?> </p>
            <p class="claim_data">Interest     : <?php echo $start_call[0]->interest;?> </p>
            <p class="claim_data">Coinsurance    : <?php echo $start_call[0]->coinsurance;?> </p>
            ...
            <p class="claim_data">Cashed Date    : <?php echo $start_call[0]->cashed_date;?> </p>
            <p class="claim_data">Payer    : <?php echo $start_call[0]->payer;?> </p>
            <p class="claim_data">Method    : <?php echo $start_call[0]->method;?> </p>
            <p class="claim_data">Payment  : <?php echo $start_call[0]->payment;?> </p>
            <p class="claim_data">Bulk Amount    : <?php echo $start_call[0]->bulk_amount;?> </p>
