...
<nav id="sidebar" class="sidebar-wrapper">
  ...
  <div class="side-menu">
    <ul class="menu">
      ...
      <?php if($userdata['department']=='Data' || $userdata['role']=='agent' || $userdata['role']=='supervisor' ){?>
        <li class="<?php if($actlinks  == "dataprocess") echo "active";?>">
          <i class="fas fa-shield-alt"></i>
          <a class="<?php if($actlinks == "dataprocess") echo "active";?>" href="<?php echo base_url();?>dataprocess">Data Productivity</a>
        </li>
      <?php } ?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body mons">
        ...
        <input class="col-md-12 col-xs-12 form-control" type="text" id="name" name="name" placeholder="Name" required="">
          ...
          <input type="checkbox" onclick="myFunction()"><label for="checkbox"> View Password</label>
          ...
          <br>
          <p class="">Client:</p>
          <!-- <select data-placeholder="Choose Client..." class="chosen-select form-control" multiple tabindex="4" name="client[]" required="" style="height:500px !important;">
            <option value=""></option>
             <?php for($i=0;$i<count($cli);$i++){ ?>
                <option value="<?php echo $cli[$i]->client;?>"><?php echo $cli[$i]->client?></option>
              <?php } ?>
          </select> -->
          <select data-placeholder="Choose Client..."  class="form-control"  name="sandstone[]" required="" multiple>
                <option value="">--Select Client--</option>
                    <?php
                    $clientlist = $this->Mainmodel->getuserlist();
          ...
          <br><br>
            ...
            <img id="view_img" src="#" alt="your image" style="width:200px;display:none;" /><br><br>
