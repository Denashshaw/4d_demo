...
<nav id="sidebar" class="sidebar-wrapper">
  ...
  <div class="side-menu">
    ...
    <?php } ?>
      ...
      <?php if($userdata['role']=='admin' || $userdata['role']=='manager' || ($userdata['role']=='supervisor')){?>
      ...
      <?php if($userdata['role']!='agent' && $userdata['role']=='admin'){ ?>
      <li class="<?php if($actlinks  == "capa_dashboard") echo "active";?>">
          <i class="fa fa-user-secret" aria-hidden="true"></i>
          <a class="<?php if($actlinks == "capa_dashboard") echo "active";?>" href="<?php echo base_url('Capa_controller/index');?>">CAPA Dashboard</a>
      </li>
      <?php } ?>
