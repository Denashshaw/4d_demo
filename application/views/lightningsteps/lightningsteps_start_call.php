      ...
      <div class="row">
        <div class="col-12 col-md-12 content" style="min-height:780px;">
          ...
          <div class="col-md-5"><br>
            ...
            <p class="claim_data">Created Date (MM/DD) : <?php $assign_date=substr($start_call[0]->created_date,5);
                echo substr($assign_date,0,-3);?> </p>
            <p class="claim_data">Date Range            : <?php echo $start_call[0]->date_range;?> </p>
            <p class="claim_data">Claims Bucket         : <?php echo $start_call[0]->claims_bucket;?> </p>
            <p class="claim_data">Claim                 : <?php echo $start_call[0]->claim_id;?> </p>
            <p class="claim_data">Claims Name          : <?php echo $start_call[0]->patient;?> </p>
            <p class="claim_data">Service                : <?php echo $start_call[0]->service;?> </p>
            <p class="claim_data">Location               : <?php echo $start_call[0]->location;?> </p>
            <p class="claim_data">Payor             : <?php echo $start_call[0]->payor;?> </p>
            <p class="claim_data">Billed               : <?php echo $start_call[0]->billed;?> </p>
            <p class="claim_data">Payment               : <?php echo $start_call[0]->payment;?> </p>
            <p class="claim_data">Adjustment             : <?php echo $start_call[0]->adjustment;?> </p>
            <p class="claim_data">Writeoff      : <?php echo $start_call[0]->writeoff;?></p>

            <p class="claim_data">Balance      : <?php echo $start_call[0]->balance;?> </p>
            <p class="claim_data">Expected Revenue               : <?php echo $start_call[0]->expected_revenue;?> </p>
            <p class="claim_data">Expected Collection    : <?php echo $start_call[0]->expected_collection;?> </p>
            <p class="claim_data">Status    : <?php echo $start_call[0]->status;?> </p>
            <p class="claim_data">Allowed Amount    : <?php echo $start_call[0]->allowed_amount;?> </p>
            <p class="claim_data">Deductible    : <?php echo $start_call[0]->deductible;?> </p>
            <p class="claim_data">Co Insurance    : <?php echo $start_call[0]->co_insurance;?> </p>
            <p class="claim_data">Copay    : <?php echo $start_call[0]->copay;?> </p>
            <p class="claim_data">Amount Paid     : <?php echo $start_call[0]->amount_paid;?> </p>
            <p class="claim_data">Date Paid     : <?php echo $start_call[0]->date_paid;?> </p>
            <p class="claim_data">Last Follow Up Date    : <?php echo $start_call[0]->last_follow_up_date;?> </p>
            <p class="claim_data">Claims Notes    : <?php echo $start_call[0]->claim_notes;?> </p>
            <p class="claim_data">Claims Numbers    : <?php echo $start_call[0]->claim_numbers;?> </p>
            <p class="claim_data">Check Numbers  : <?php echo $start_call[0]->check_numbers;?> </p>
            <p class="claim_data">EFT Number    : <?php echo $start_call[0]->eft_number;?> </p>
...
$(document).on('submit', '#claim_call', function(event){
  ...
  var work_status                     = $('#work_status').val();
  var call_made                       = $('input[name=call_made]').val();
  ...
  var notes                           = $('#notes').val();
  var spell_check                     = $('input[name=call_made]:checked').val();
